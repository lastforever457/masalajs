...
function Tugadi(props: IBoshlandiProps) {
    return (
        <Accordion
            className="contest-item alert alert-danger"
            key={props.index}
        >
            <AccordionSummary
            ...
            >
                ...
                >
                    ...
                    <div
                        className={`alert m-0 py-1 px-2 d-flex justify-content-center align-items-center alert-danger`}
                    >
                        Tugadi
                    </div>
                </div>
